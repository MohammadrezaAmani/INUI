                        ...
                        Div(
                            ...
                            data = (
                                ...
                                P(
                                    ...
                                    data = ('''Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas id magna ac quam semper.deta''',)
                                ), 
                                Div(
                                    classs='''row''',
                                    data = (
                                ...
                                P(
                                    classs='''shipping''',
                                    data = ('''Available for Free Ground Shipping & Return''',)
                                ), )
                        ), )
                ), )
        ), )
