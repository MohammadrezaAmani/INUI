                    ...
                    data=(
                        ...
                        Ul(
                            ...
                            data=(
                                ...
                                Li(
                                    classs="""tabs-title""",
                                    data=(A(href="""#panel2c""", data=("""Tab 2""",)),),
                                ),
                                Li(
                                    classs="""tabs-title""",
                                    data=(A(href="""#panel3c""", data=("""Tab 3""",)),),
                                ),
                                Li(
                                    classs="""tabs-title""",
                                    data=(A(href="""#panel4c""", data=("""Tab 4""",)),),
                                ),
                                Div(
                                    classs="""slide""",
                                ),
                            ...
                            data=(
                                Div(
                                    ...
                                    data=(
                                        P(
                                            data=(
                                                """Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet pulvinar enim. Donec mattis metus a hendrerit aliquam. Nulla facilisi. Etiam facilisis, nisi eu varius gravida, tellus odio blandit mauris, et egestas neque sapien sit amet massa.
      ...
      """,
                                ...
                                Div(
                                    ...
                                    data=(
                                        P(
                                            data=(
                                                """Nunc ipsum massa, venenatis sed fringilla ut, elementum eu sapien. In eget dolor volutpat, fringilla metus et, dignissim lectus. Proin interdum sit amet odio ut varius. Nam id quam lacus. Aenean et tellus a sapien pulvinar sollicitudin. Mauris posuere
        tellus urna, non fermentum urna scelerisque in. Nulla scelerisque est leo, non tempus purus laoreet in. Aliquam erat volutpat. Nunc nulla eros, blandit quis nunc vel, luctus fermentum nisi. Phasellus ullamcorper gravida facilisis.""",
                                ...
                                Div(
                                    ...
                                    data=(
                                        P(
                                            data=(
                                                """Donec ornare, ex quis volutpat vulputate, dui eros fermentum tellus, id eleifend velit diam non leo. Aliquam convallis vestibulum elementum. Phasellus facilisis tempus nisi eget lobortis. Duis magna sem, placerat vel tellus sed, auctor laoreet enim.
        ...
        mi fermentum pulvinar. Mauris fermentum tortor id ipsum tristique sollicitudin.""",
                                ...
                                Div(
                                    ...
                                    data=(
                                        P(
                                            data=(
                                                """Fusce justo velit, pulvinar eu sem eu, fringilla sodales urna. Mauris mollis aliquet nibh. Suspendisse porttitor, nisi a egestas iaculis, augue metus semper tortor, eget tristique leo enim mollis libero. Integer et lacus non ipsum finibus pharetra
