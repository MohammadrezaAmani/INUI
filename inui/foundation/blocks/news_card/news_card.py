            ...
            data=(
                Div(
                    ...
                    data=(
                        Span(
                            classs="""label""",
                            data=(A(href="""#""", data=("""Angular 2""",)),),
                        ),
                        Span(
                            classs="""label""",
                            data=(A(href="""#""", data=("""Angular 4""",)),),
                        ),
                    ),
                ),
                Div(
                                ...
                                Article(
                                    ...
                                    data=(
                                        ...
                                        P(
                                            ...
                                            data=(
                                                """Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae facere, ipsam quae sit, eaque perferendis commodi!...""",
                                            ),
                                        ),
                                    ),
                                ),
