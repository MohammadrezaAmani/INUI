                                ...
                                Div(
                                    ...
                                    data = (
                                        H1(
                                            ...
                                            data = ('''Welcome to Foundation for Sites''',)
                                        ), )
                                ), )
                        ), 
                        Div(
                                        ...
                                        Div(
                                            ...
                                            data = (
                                                H3(
                                                    ...
                                                    data = ('''We’re stoked you want to try Foundation! ''',)
                                                ), 
                                                P(

                                                    data = ('''To get going, this file (index.html) includes some basic styles you can modify, play around with, or totally destroy to get going.''',)
                                                ), 
                                                P(

                                                    data = ('''Once you've exhausted the fun in this document, you should check out:''',)
                                                ), 
                                                Div(
                                                    classs='''grid-x grid-margin-x''',
                                                    data = (
                                ...
                                Div(
                                    ...
                                    data = (
                                                                ...
                                                                P(
                                                                    ...
                                                                    data = (
                                                                        Strong(
                                                                            ...
                                                                            data = ('''This is a twelve column section in a grid-x with grid-margin-x.''',)
                                                                        ), )
                                                                ), )
                                                        ), )
                                                ), )
                                        ...
                                        H5(
                                            ...
                                            data = ('''We bet you’ll need a form somewhere:''',)
                                        ), 
                                        Form(
                                        ...
                                        Div(
                                            ...
                                            data = (
                                                H5(
                                                    ...
                                                    data = ('''So many components, girl!''',)
                                                ), 
                                                P(

                                                    data = ('''A whole kitchen sink of goodies comes with Foundation. Check out the docs to see them all, along with details on making them your own.''',)
                                                ), 
                                                A(
                                                    href='''https://get.foundation/docs/''',
                                                    classs='''small button''',
