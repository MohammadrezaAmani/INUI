                                        ...
                                        Div(
                                            ...
                                            data = (
                                                H5(
                                                    ...
                                                    data = ('''{{#if title}}{{title}}{{else}}Hotel{{/if}}''',)
                                                ), 
                                                Div(
                                                        ...
                                                        Div(
                                                            ...
                                                            data = (
                                                                H6(
                                                                    ...
                                                                    data = ('''New York Royale''',)
                                                                ), 
                                                                P(

                                                                    data = ('''The rooms and suites have free WiFi and flat-screen TVs. Upgrades include outdoor decks with the gorgeous Manhattan views, 24-hour room service, and  cocktail bars.''',)
                                                                ), )
                                                        ), )
                                                ), )
                                        ), 
